...
@pytest.mark.parametrize("num1,num2,expectedResult", [(4, 5, 9), (-4, -5, -9), (4, -5, -1)])
...
@pytest.mark.parametrize("num1,num2,expectedResult", [(24, 3, 8), (-24, -3, 8), (-24, 3, -8)])
